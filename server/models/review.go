...
type Review struct {
	...
	TaskID     uint      `gorm:"not null;uniqueIndex:idx_task_reviewer;index" json:"task_id"`
	Task       Task      `gorm:"foreignKey:TaskID" json:"task,omitempty"`
	ReviewerID uint      `gorm:"not null;uniqueIndex:idx_task_reviewer;index" json:"reviewer_id"`
